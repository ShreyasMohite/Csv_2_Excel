...
class Converting_2_Excel:
    def __init__(self,root):
        self.root=root
        self.root.title("Csv to Excel Convertion")
        self.root.geometry("500x300")
        self.root.iconbitmap("logo863.ico")
    ...
    #==============================command=======================================#
        ...
        def browse():
           global filename
           file_path = filedialog.askopenfilename(title = "Select file",filetypes = (("CSV","*.csv"),("all files","*.*")))
           if len(file_path)!=0:
        ...
        def convert_excel():
            if save.get()!="":
                ...
                myfile=pd.ExcelWriter('{}.xlsx'.format(save.get()))
    ...
    #=====================================================================#
        ...
        lab_frame=LabelFrame(top_frame,text="Convert Csv to Excel",width=490,height=258,font=('times new roman',12,'bold'),bg="#1c45ea",fg="white")
    ...
    #========================lab_frame=============================================#
        ...
        but_convert_jpg=Button(lab_frame,text="Convert-Excel",width=15,font=('times new roman',12,'bold'),cursor="hand2",command=con_excel)
